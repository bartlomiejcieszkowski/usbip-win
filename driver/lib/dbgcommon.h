...
#define DBGE(part, fmt, ...)	DbgPrintEx(MY_DFPLTR, DPFLTR_MASK | ((part) << 4) | DPFLTR_ERROR_LEVEL, DRVPREFIX ":(EE) " fmt "\n", ## __VA_ARGS__)
#define DBGW(part, fmt, ...)	DbgPrintEx(MY_DFPLTR, DPFLTR_MASK | ((part) << 4) | DPFLTR_WARNING_LEVEL, DRVPREFIX ":(WW) " fmt "\n", ## __VA_ARGS__)
#define DBGI(part, fmt, ...)	DbgPrintEx(MY_DFPLTR, DPFLTR_MASK | ((part) << 4) | DPFLTR_INFO_LEVEL, DRVPREFIX ": " fmt "\n", ## __VA_ARGS__)
